...
const Page1 = lazy(() => import('./pages/story-5/index'));
    ...
    <BrowserRouter>
      <div style={{ fontFamily: 'system-ui, sans-serif', minHeight: '100vh', background: '#f9fafb' }}>
        <nav style={NAV_STYLE}>
          ...
          <Link to="/invoices" style={LINK_STYLE}>Invoices</Link>
          <Link to="/billing" style={LINK_STYLE}>Billing Settings</Link>
        </nav>
        <main style={{ padding: '2rem 1.5rem', maxWidth: 1024, margin: '0 auto' }}>
          <Suspense fallback={<p>Loading…</p>}>
            <Routes>
              <Route path="/" element={<Page0 />} />
              <Route path="/invoices" element={<Page1 />} />
              <Route path="/billing" element={<Page2 />} />
